...
$.widget( "custom.customTabular", {
	  ...
	  _init:function(){
          ...
          getInput:function(i){
                    ...
                    /*
                    * @Description. If para comprobar que exista en i.value dentro del catalogo
                    * en caso contrario poner un -1 por default para que en la vista aparezca la 
                    * leyenda "Seleccione una opcion" en el combo
                   
                    if (i.type == 'select' && i.datatype == 'list') {
                           

                                  
                                  let catalogo = i.list.list;
                                          for (let contadorTmp=0;  contadorTmp < catalogo.length; contadorTmp++) {

                                              if (catalogo[contadorTmp]['value'] == i.value) {
                                                  break;
                                              }

                                                                                       if(contadorTmp == catalogo.length-1){
                                             i.value = -1
                                          }
                                          }
                    ...
                    */
                    ...
                    for(var x in o.data){
                            ...
                            /*if((obj.options.userActive.program!=8) )  
                              {
                              	if(o.data[x].field!='modulopredio_cup')
                              	 {
                                   contador+=1;
                              	 }
                              }

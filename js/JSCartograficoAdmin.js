...
function TblCartoDetalleAdmin(action, user, folio, programa){
    var dataf = 'action=' + action + '&user=' + user + '&folio=' + folio + '&programa=' + programa;
    console.log(dataf);
    //alert(dataf);
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function(index, data){
             ...
             $('#btn_modal').on('click',function() { 
                    ...
                    TblMultiregistro("getAdmin", user, folio, programa, "multi", consulta); 
...
function TblMultiregistro(action, user, folio, programa, multi, consul){
    console.log("entro al multi");
    var dataf = 'action=' + action + '&user=' + user + '&folio=' + folio + '&programa=' + programa + '&multi=' + multi + '&consul=' + consul;
    console.log(dataf);
    $.ajax({
